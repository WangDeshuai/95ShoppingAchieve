...
-(id)initWithXiangXiDic:(NSDictionary*)dic{
    ...
    if (self) {
        ...
        _phoneName=[ToolClass isString:[NSString stringWithFormat:@"%@",[dic objectForKey:@"M_MobieNum"]]];//E_Number
        //具体参数
...
-(id)initWithXiangXiPhoneDic:(NSDictionary*)dic{
    self=[super init];
    if (self) {
         _phoneName=[ToolClass isString:[NSString stringWithFormat:@"%@",[dic objectForKey:@"E_Number"]]];//E_Number
    }
