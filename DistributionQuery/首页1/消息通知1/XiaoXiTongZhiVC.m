...
@interface XiaoXiTongZhiVC ()<SGTopTitleViewDelegate,UIScrollViewDelegate>
@property (nonatomic, strong) SGTopTitleView *topTitleView;
@property (nonatomic, strong) NSArray *titles;
@property (nonatomic, strong) UIScrollView *mainScrollView;
@end

@implementation XiaoXiTongZhiVC
...
- (void)viewDidLoad {
    ...
    XitongTongZhiVC *oneVC = [[XitongTongZhiVC alloc] init];
...
- (void)setupChildViewController {
    ...
    //
    ShangXinVC *twoVC = [[ShangXinVC alloc] init];
